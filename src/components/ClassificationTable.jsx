  ...
  return (
    <div className="classification-table-container">
      ...
      <div className="table-responsive">
        {' '}
        {/* Adicionado para melhor visualização em mobile */}
            ...
            {sortedTeams.map((team, index) => (
              <tr key={team.id}>
                ...
                <td className="team-name-cell">
                  ...
                  <span className="teamName" title={team.name}>
                    {team.name}
                  </span>
                </td>
                <td title="Pontuação">{team.P}</td>
                <td title="Vitórias">{team.V}</td>
                <td title="Empates">{team.E}</td>
                <td title="Derrotas">{team.D}</td>
                <td>{team.GP}</td>
                <td>{team.GC}</td>
                <td>{team.SG}</td>
              </tr>
