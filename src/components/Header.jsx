    ...
    <header className="header">
      ...
      <nav className={`sidebar ${isSidebarOpen ? 'is-open' : ''}`}>
        <ul className="sidebar-menu">
          ...
          <li>
            {' '}
            <Link to="/jogos" onClick={toggleSidebar}>
              Jogos
            </Link>
          </li>
          <li>
            {' '}
            <Link to="/equipes" onClick={toggleSidebar}>
              Equipes
            </Link>
          </li>
          <li>
            {' '}
            <Link to="/mata-mata" onClick={toggleSidebar}>
              Mata-Mata
            </Link>
          </li>
          <li>
            {' '}
            <Link to="/artilharia" onClick={toggleSidebar}>
              Artilharia
            </Link>
          </li>
          <li>
            {' '}
            <Link to="/noticias" onClick={toggleSidebar}>
              Noticias
            </Link>
          </li>
        </ul>
